...
// export const GET_INFINITE_POSTS = async (cursor: string = "") => {
//   const url = "https://[YOUR_APPWRITE_SERVER_URL]/v1/databases/[DATABASE_ID]/collections/[COLLECTION_ID]/documents";

//   const headers = {
//     "X-Appwrite-Project": "[YOUR_PROJECT_ID]",  // Your Appwrite Project ID
//     "X-Appwrite-Key": "[YOUR_API_KEY]",         // Your API Key, if required
//     "Authorization": `Bearer [YOUR_AUTH_TOKEN]`, // Authorization token, if required
//   };

//   const queryParams = new URLSearchParams();
//   queryParams.append("limit", "10");  // Limit the number of posts
//   if (cursor) queryParams.append("cursor", cursor);  // Use cursor if pagination is needed
...
//       const delay = (Number(resetTime) - Date.now() / 1000) * 1000;
